...
void Init(TTree *tree) {
  ...
  tree->SetMakeClass(1);
	...
	tag_HLT_IsoMu22_branch = 0;
	if (tree->GetBranch("tag_HLT_IsoMu22") != 0) {
	...
	tag_HLT_IsoTkMu22_branch = 0;
	if (tree->GetBranch("tag_HLT_IsoTkMu22") != 0) {
